...
describe("Application", () => {
  ...
  it("loads data, books an interview and reduces the spots remaining for Monday by 1", async () => {
    ...
    /* 3. Click the "Add" buttton on the first empty appointment */
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    // 3. Click the "Delete" button on the first on booked appointment.
    const appointments = getAllByTestId(container, "appointment"); 
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 3. Click the "Edit" button on the first on booked appointment.
  ...
  it("shows the save error when failing to save an appointment", async () => {
    // sets up the fake error with axios once
    ...
    // 8. Check that an error message is rendered 
